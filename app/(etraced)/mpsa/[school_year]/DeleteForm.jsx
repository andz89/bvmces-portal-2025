...
import { deleteMPSReport } from "./actions";
import FullPageLoader from "../../../components/loader/FullPageLoader";
import { BiSolidTrash } from "react-icons/bi";

export default function DeleteForm({ itemId, onCancel }) {
  const [state, formAction, pending] = useActionState(deleteMPSReport, null);
