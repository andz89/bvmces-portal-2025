...
import { updateGPATerm } from "../../../features/gpa-term/actions";

import toast from "react-hot-toast";

export default function EditGPATermModal({
  openEdit,
  onClose,
  initialData,
  school_year,
    ...
    <div className="fixed inset-0 z-[9999] overflow-y-auto">
      ...
      <div className="relative min-h-screen flex items-center justify-center p-4">
        ...
        >
          ...
          >
            ...
            <div className="relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h2 className="text-3xl font-bold text-white">
                    Edit GPA Term Record
                  </h2>

                  <p className="text-white/80 mt-2 mb-1">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <div className="bg-white/10 border border-white/10  rounded-sm px-4 py-3">
                  <p className="text-xs uppercase text-white/80">Term</p>
          ...
          {/* Body */}
          <div className="min-h-0 flex-1 overflow-y-auto bg-lis-bg px-6 md:px-8 py-8">
            {/* Top Summary */}
            <div
              className="
                rounded-sm
