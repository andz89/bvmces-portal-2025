...
import { createBulkGPATerm } from "../../../features/gpa-term/actions";
...
export default function BulkAddGPATermModal({
  open,
  onClose,
  school_year,
  classData,
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h2 className="text-3xl font-bold text-white">
                    Create GPA Term Records
                  </h2>

                  <p className="text-white/80 mt-2">
                    Generate learner GPA templates for the selected term.
                  </p>
                </div>
              </div>
              ...
              >
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-lis-muted">
                      Choose which term to create GPA records for.
                    </p>
                  </div>
                </div>
