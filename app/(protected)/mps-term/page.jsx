  ...
  return (
    <div className="min-h-screen bg-lis-panel-header p-6">
      ...
      <div className="relative overflow-hidden rounded-sm bg-lis-primary    p-8 text-white ">
        ...
        <div className="absolute bottom-0 left-10 h-40 w-40 rounded-full bg-lis-panel-header/20 " />
        ...
        <div className="relative z-10 flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-3 max-w-xl text-sm text-white/80">
              Access and manage Mean Percentage Score reports by term and
              examination type, organized by school year.
            </p>
          </div>
      ...
      <div className="mt-10 mb-6">
        ...
        <p className="mt-1 text-sm text-lis-muted">
          Select a school year to open MPS Term reports
        </p>
      </div>
        ...
        {[...school_year]
          ...
          .map((data) => (
            <Link
              key={data.id}
              href={{
                pathname: `/mps-term/${data.year_label}`,
              }}
              className="group"
            >
              <div className="relative overflow-hidden rounded-sm border border-lis-panel-border bg-white p-6  transition-all duration-300 hover:-translate-y-1 ">
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    <div className="rounded-full bg-lis-panel-header p-2 text-lis-muted transition group-hover:bg-lis-primary group-hover:text-white">
